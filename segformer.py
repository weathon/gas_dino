...
class MyModel(nn.Module):
    ...
    def forward(self, current_frame, long_bg, short_bg):
        ...
        # print(last_n)
        res = torch.zeros((long_bg[0].shape[0], args.image_size//8 * args.image_size//8, 384 * 2)).to(long_bg[0].device)
        ...
        return self.head(current_frame.reshape(long_bg[0].shape[0], args.image_size//8, args.image_size//8, 384 * 2).permute(0,3,1,2))
